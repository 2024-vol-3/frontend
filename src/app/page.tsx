...
export default function Home() {
  return (
    <>
      <Box bg='#fff'>
        <Box h='30vh' minH='300px' w='1500px' m='0 auto' bg='#fff' display='flex' alignItems='center' justifyContent='center'>
          <Image src="/Recallllll_BlackLogo2.png" width={800} height={400} alt="Recallllll_BlackLogo2"/>
        </Box>
        ...
        <Box h='30vh' minH='300px' w='90vw' minW='1500px' m='0 auto' roundedTopRight='10px' roundedTopLeft='10px' bg='#fffeee'>
          <Flex>
            <Box h='30vh' minH='300px' w='70%' display='flex' alignItems='center' justifyContent='space-around'>
              <Link href='/categories'>
                <Button size="lg" color='#fff' fontSize='36px' pt='46px' pb='46px' pr='30px' pl='30px' bgColor='#222' variant="solid" colorScheme="gray" shadow='rgba(0, 0, 0, 0.1) 0px 0px 0px, rgba(0, 0, 0, 0.2) 0px 5px 10px, rgba(0, 0, 0, 0.4) 0px 10px 15px'>
                  単語帳一覧はコチラから!
                </Button>
              </Link>
            </Box>
